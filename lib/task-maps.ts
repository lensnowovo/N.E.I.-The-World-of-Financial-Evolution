...
export const taskMaps: TaskMap[] = [
  {
    ...
    title: '项目初筛工作台',
    shortTitle: '拆 BP',
    description: '先把项目事实读清楚，再补充外部信息并形成第一轮判断。',
    scenes: ['screening'],
    outcome: '项目事实卡 / 初筛意见 / 关键追问 / 下一步建议',
    preview: '拆事实 · 快速判断 · 补行业 · 找风险 · 写意见',
    intents: [
      {
        slug: 'read-materials',
        title: '拆解 BP 与项目事实',
        description: '提取公司、产品、客户、商业模式、关键数据与材料缺口。',
        postIds: [156, 23],
      },
      {
        slug: 'quick-screen',
        title: '判断是否值得继续看',
        description: '在项目事实底稿上完成第一轮筛选，明确判断依据。',
        postIds: [48],
      },
      {
        slug: 'market-context',
