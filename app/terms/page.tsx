...
const sections = [
  ...
  ['二、服务范围', [
    'N.E.I. 提供公开 Skill、Prompt、Workflow 与 MCP 信息目录的浏览、搜索、收藏和分发，并逐步提供 Memory Node 的下载与授权管理。站内公开投稿、评论、点赞和关注当前暂停。功能可能因 Beta 测试、维护、安全或合规要求调整。',
  ...
  ['四、内容贡献与历史投稿', [
    '普通账号当前不能通过网站直接投稿或编辑公开内容。内容线索可通过 GitHub Issue 或 Pull Request 提供，由管理员审核、整理并决定是否入库。',
