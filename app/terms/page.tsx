    ...
    <div className="mx-auto max-w-3xl px-4 sm:px-6 py-10">
      ...
      <div className="prose-manuscript max-w-none space-y-6 text-sm leading-7 text-leather">
        <section>
          ...
          <p>N.E.I.（nei-pevc.com）是一个面向一级市场从业者的 PEVC AI Skill Hub。平台提供以下服务：浏览和搜索 Skill / Workflow / 方法论；收藏、评论、投稿；通过 MCP 协议将公开且已准入的 Skill 全库和用户收藏库分发给用户的 Agent 客户端（如 Claude Code、Codex、Workbuddy 或其它支持 MCP 的 Agent 客户端）。</p>
        </section>
        <section>
