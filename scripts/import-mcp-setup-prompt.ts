...
<h2>使用前提</h2>
<ol>
<li>你已经在 N.E.I. 网站（<a href="https://n-e-i-the-world-of-financial-evolut.vercel.app">n-e-i-the-world-of-financial-evolut.vercel.app</a>）注册了账号</li>
<li>你已经在设置页生成了 MCP Token（设置页 → MCP Server → 生成 Token）</li>
...
2. 添加一个名为 "nei" 的 MCP Server，配置如下：
   ...
   - URL：https://n-e-i-the-world-of-financial-evolut.vercel.app/api/mcp
...
<li>复制上面的 Prompt，把 <code>[在这里粘贴你的 MCP Token]</code> 替换成你的实际 Token</li>
    ...
    data: {
      ...
      skillAsset: {
        create: {
          ...
          sourceUrl: 'https://n-e-i-the-world-of-financial-evolut.vercel.app/mcp',
